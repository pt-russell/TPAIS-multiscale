...
{\bf Keywords: Importance sampling, ensemble, transport map,
...
\begin{figure}
\centering
\subfigure[Marginal density function for $\theta_1$.]{\includegraphics[width=0.31\textwidth]{"R2_marginal_1"}}
\subfigure[Marginal density function for $\theta_2$.]{\includegraphics[width=0.31\textwidth]{"R2_marginal_2"}}
\subfigure[Contour plot for Rosenbrock density.]{\includegraphics[width=0.31\textwidth]{R2_posterior}}
...
\begin{figure}[htpb]
\centering
\subfigure[Original sample $\theta$ from MH-RW algorithm.]{\includegraphics[width=0.31\textwidth]{"R2_transport_orig"}}\quad
\subfigure[Push forward of $\theta$ onto reference space.]{\includegraphics[width=0.31\textwidth]{"R2_transport_ref"}}\quad
\subfigure[Pull back of reference sample onto target space.]{\includegraphics[width=0.31\textwidth]{R2_transport_pullback}}
...
options.]{\includegraphics[width=0.45\textwidth]{R1_L2}}
\subfigure[Comparison of Transport ETAIS option (3) with the standard algorithms.]{\includegraphics[width=0.45\textwidth]{R1_L2_all}}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.9\textwidth]{"CMA_posterior"}
...
\begin{figure}[!htb]
\centering
\subfigure[Sampling algorithms with no preconditioner for $\tilde{T}$.]{\includegraphics[width=0.495\textwidth]{"CMA_L2_param_space"}}
\subfigure[Sampling algorithms with a $\log$ preconditioner for $\tilde{T}$.]{\includegraphics[width=0.495\textwidth]{"CMA_L2_log_space"}}
...
no log
preconditioner.]{\includegraphics[width=0.8\textwidth]{"CMA_ref_space_MHTRW"}}
\\
\subfigure[Push forward of the posterior sample through $\hat{T}$ with log preconditioner.]{\includegraphics[width=0.8\textwidth]{"CMA_ref_space_MHlogTRW"}}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.9\textwidth]{"Diff_CMA_QEA"}
...
\begin{figure}[!htb]
\centering
\subfigure[Marginal for $\hat{k}_4^{\text{QEA}}$.]{\includegraphics[width=0.495\textwidth]{"QEA_approx_marginal"}}
\subfigure[Marginal for $\hat{k}_4^{\text{CMA}}$.]{\includegraphics[width=0.495\textwidth]{"CMA_approx_marginal"}}
...
\begin{figure}[htb]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{"GRN_posterior"}}%
...
\begin{figure}[!htb]
\centering
\subfigure[Sampling algorithms with no preconditioner for $\tilde{T}$.]{\includegraphics[width=0.495\textwidth]{"GRN_convergence"}}
\subfigure[Sampling algorithms with a $\log$ preconditioner for $\tilde{T}$.]{\includegraphics[width=0.495\textwidth]{"GRN_convergence_log"}}
\caption{Convergence of eight different MCMC algorithms for the CMA
