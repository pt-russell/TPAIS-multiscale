...
targets****CITE FASTER PAPER*****, large data sets ****zigzag****,
...
data****stochastic mala, HMC****, methods which are able to exploit
the geometry of the target***riemannian****. Population Monte Carlo
...
of the target***cite standard papers including AIS etc****. These methods are particularly useful in the context of
...
In ****cite PAIS***, we explored ideas from adaptive MCMC within a
...
resamplers****cite sebastian***, and a greedy approximation (the
...
proposed, including the work of Marzouk and Parnod***cite***, who
...
mapped to highly informed moves on the parameter space.
...
is used in situations where ODE or diffusion****Chem langevin****
...
species****Gillespie****. Biochemical networks typically fall into
...
A range of numerical methods have been suggested to tackle this latter
problem, including tau-leaping***cite****, diffusion approximations
***radek and Yannis, cotter and Yannis****, quasi-steady state
approximations ****slow scale and nested****, and other averaging
arguments ****cotter comp. phys****. Some of these approaches are more
...
types of fast subsystems***product-form papers****.
...
\emph{sloppiness}***cite*** of the likelihood is a challenging problem
that appears in many applications in science and engineering***active
subspaces literature here****.

In this work, we aim to improve the PAIS machinery, which is limited,
as the same proposal kernel is used for each particle in the
ensemble. This homogeniety of proposal kernels means that complex
...
As shown in ***cite marzouk****, transport maps can be used to create
