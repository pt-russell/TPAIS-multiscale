...
densities arise which are concentrated on, or close to, lower dimensional
...
iteration. The PAIS is summarised in Algorithm \ref{alg:PAIS}, where
...
\subfigure[Comparison of Transport PAIS option (3) with the standard algorithms.]{\includegraphics[width=0.45\textwidth]{images/TPAIS/R1_L2_all}}
